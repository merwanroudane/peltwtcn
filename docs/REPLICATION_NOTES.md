...
Protocol B, 25 epochs, real data:
...
Two things to notice. The LSTM and GRU beat the paper's published figures. And
**Theil's U is about 1.0**, meaning these models roughly *match* a random walk
